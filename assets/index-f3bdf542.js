import{u}from"./header-7e68b570.js";import{g as k,p as m,l as v,m as f}from"./modal-2ce7dd6c.js";const a=()=>{const t=JSON.parse(localStorage.getItem("favorite-cocktails"));t!==null&&t.length!==0&&setTimeout(()=>{const s=document.querySelectorAll(".cocktails__item");t.forEach(c=>{s.forEach(o=>{if(c.idDrink===o.id){const e=o.children[1].children[1].children[1];e.children[0].textContent="Remove",e.classList.add("cocktails__remove-favorite"),e.querySelector(".cocktails__icon--white").children[0].setAttribute("href","../../../assets/icons/symbol-defs.svg#icon-full-heart"),e.querySelector(".cocktails__icon--black").children[0].setAttribute("href","../../../assets/icons/symbol-defs.svg#icon-full-heart"),setTimeout(()=>{e.classList.remove("cocktails__add-favorite")},500)}})})},500)};a();const r=async t=>{const s=document.querySelector(".cocktails"),c=await k(t);s.innerHTML="",c.forEach(o=>{const e=`
