import{u as k}from"./modal-7642a63a.js";import{i,g as m,p,l as v,m as f}from"./add-to-favorite-8444645e.js";const a=()=>{const t=JSON.parse(localStorage.getItem("favorite-cocktails"));t!==null&&t.length!==0&&setTimeout(()=>{const o=document.querySelectorAll(".cocktails__item");t.forEach(c=>{o.forEach(e=>{if(c.idDrink===e.id){const s=e.children[1].children[1].children[1];s.children[0].textContent="Remove",s.classList.add("cocktails__remove-favorite"),s.querySelector(".cocktails__icon--white").children[0].setAttribute("href",`${i}#icon-full-heart`),s.querySelector(".cocktails__icon--black").children[0].setAttribute("href",`${i}#icon-full-heart`),setTimeout(()=>{s.classList.remove("cocktails__add-favorite")},500)}})})},500)};a();const l=async t=>{const o=document.querySelector(".cocktails"),c=await m(t);o.innerHTML="",c.forEach(e=>{const s=`
