import"./modal-4f0ab525.js";const i=()=>{const e=JSON.parse(localStorage.getItem("favorite-ingredients"));if(e&&e.length>0){e.forEach(t=>{});const n=document.querySelector(".ingredients__list");e.forEach(t=>{const s=`
