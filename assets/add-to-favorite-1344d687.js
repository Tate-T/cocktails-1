import{_ as h,i as u}from"./modal-c5a8f1cc.js";const d="/cocktails-1/assets/symbol-defs-bc6ac176.svg",n=[],v=()=>{const o=JSON.parse(localStorage.getItem("favorite-cocktails"));if(o!==null&&o.length!==0){o.forEach(i=>{n.push(i)});const s=document.querySelector(".cocktails");o.forEach(i=>{const e=`
