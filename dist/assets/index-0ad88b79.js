          ...
          <div class="cocktails__box">
            ...
            <button class="cocktails__add-favorite cocktails__add-favorite--styles">
              ...
              <svg class="cocktails__icon cocktails__icon--white">
                <use href="./assets/symbol-defs-b233ebc0#icon-white-heart"></use>
              </svg>
              <svg class="cocktails__icon cocktails__icon--black">
                <use href="./assets/symbol-defs-b233ebc0#icon-black-heart"></use>
              </svg>
            </button>
          </div>
        </div>
      </li>
    `;s.insertAdjacentHTML("beforeend",e)})},p=async t=>{try{return{drinks:((await fetch(`https://www.thecocktaildb.com/api/json/v1/1/search.php?s=${t}`).then(e=>e.json())).drinks||[]).filter(e=>e.strAlcoholic==="Non alcoholic")}}catch(s){return console.error(s),{drinks:[]}}},g=()=>{const t=document.querySelector(".header__form-input"),s=document.querySelector(".cocktails"),c=document.querySelector(".pagination-box");t.addEventListener("input",async()=>{if(console.log(t.value),t.value!==""){const o=await p(t.value).then(e=>e.drinks);s.innerHTML="",c.style.display="none",o.forEach(e=>{console.log(e);const n=`
